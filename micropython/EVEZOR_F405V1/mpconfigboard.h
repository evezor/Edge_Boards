#define MICROPY_HW_BOARD_NAME       "Evezor CPU v1 STM32F405"
...
//This uart interferes with CAN2 and SPI2
#define MICROPY_HW_UART3_NAME   "UART3"    // on RX / TX D0 / D1
...
#define MICROPY_HW_UART1_NAME   "UART1"   // on SDA/SCL //Andrew changed from above
#define MICROPY_HW_UART1_TX     (pin_B6)  // SCL
#define MICROPY_HW_UART1_RX     (pin_B7)  // SDA
...
#define MICROPY_HW_SPI2_NAME "SPI2"  //Interferes with CAN2
#define MICROPY_HW_SPI2_NSS  (pin_B12) // CAN2 RX
#define MICROPY_HW_SPI2_SCK  (pin_B13) // SCK - CAN2 TX
#define MICROPY_HW_SPI2_MISO (pin_B14) // MISO
#define MICROPY_HW_SPI2_MOSI (pin_B15) // MOSI

#define MICROPY_HW_SPI3_NAME "SPI3"
#define MICROPY_HW_SPI3_NSS  (pin_A4) // A0
#define MICROPY_HW_SPI3_SCK  (pin_A5) // A1
#define MICROPY_HW_SPI3_MISO (pin_A6) // A2
#define MICROPY_HW_SPI3_MOSI (pin_A7) // A3
...
#define MICROPY_HW_CAN2_TX   (pin_B13) // D10
#define MICROPY_HW_CAN2_RX   (pin_B12) // D9
