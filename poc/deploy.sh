...
cp main.py bundle.py ocan.py board?.py /media/carl/PYBFLASH1
cp main.py bundle.py ocan.py board?.py /media/carl/PYBFLASH2
cp main.py bundle.py ocan.py board?.py /media/carl/PYBFLASH3
