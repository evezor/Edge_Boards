...
cp main.py bundle.py ocan.py board.py edge.py driver.py /media/carl/PYBFLASH1
cp main.py bundle.py ocan.py board.py edge.py driver.py /media/carl/PYBFLASH2
